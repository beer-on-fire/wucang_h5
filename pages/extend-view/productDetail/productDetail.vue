<template>
  <view class="container">
    ...
    <view class="tui-pro-detail"
      ...
      <view class="tui-product-title tui-border-radius">
        ...
        <activity v-if="pro_type == 'pt'"
          ...
          :list="list"
          :price="price"
          :is_vip="is_vip"></activity>

        <!-- 普通商品 -->
        <activity v-if="pro_type == 'pro'"
          :pro_type="pro_type"
          :list="list"
          :price="price"
          :is_vip="is_vip"
          :vip_switch="vip_switch"
          :my="my"></activity>
        <!-- 普通商品结束 -->
    ...
    <!--底部操作栏-->
    <Bottom :opcity="opcity"
      :shop_car_num="shop_car_num"
      :collected="collected"
      :list="list"
      @collecting="collecting"
      @showPopup="showPopup"
      @showPopupxx="showPopupxx"></Bottom>
    ...
    <ChooseSku :num="num"
      ...
      @sure="sure"
      :is_bottom_click="is_bottom_click"></ChooseSku>
    ...
    <Share v-if="is_share"
      ...
      @shareFc="shareFc"></Share>
    <!-- #ifdef H5 -->
    <Newhb ref="c1"
      :product_data="list"></Newhb>
    <!-- #endif -->
...
export default {
  ...
  methods: {
    ...
    get_code () {
      ...
      let index = this.id
      // #ifdef MP-WEIXIN 
      return productModel.postWxCode(index).then(res => {
        return res.data
      })
      // #endif
    },
    ...
    _setOrderData () {
      ...
      if (goods.vip_price != 0 && (my.data && my.data.vip && my.data.vip.status == 1 && !goods.pt != '[]' && !goods.discount != '[]')) {
