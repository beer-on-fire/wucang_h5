	...
	<view class="container">
		...
		<view class="tui-pro-detail" v-if="page_show">
			<view class="tui-product-title tui-border-radius">
				...
				<!-- 邀新拼团 -->
				<activity v-if="pro_type == 'new_pt'" :pro_type="pro_type" :list="list" :price="price"></activity>
				...
				<!-- 一般拼团 ↓↓ -->
				<activity v-if="pro_type == 'pt'" :pro_type="pro_type" :list="list" :price="price" :is_vip="is_vip"></activity>

				<!-- 普通商品 -->
				<activity v-if="pro_type == 'pro'" :pro_type="pro_type" :list="list" :price="price" :is_vip="is_vip" :vip_switch="vip_switch"
				 :my="my"></activity>
				 <!-- 普通商品结束 -->
			...
			<view class="tui-basic-info tui-mtop tui-radius-all" v-if="list.sku && list.sku.length>0">
				<view class="tui-list-cell" @tap="showPopup('shopping',false)">
	...
	export default {
		...
		methods: {
			...
			showPopup: function(e,is_bottom_click) {
				console.log('xxxxx',is_bottom_click)
