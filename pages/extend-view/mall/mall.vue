    ...
    <view class="tui-header-banner">
      <view class="tui-hot-search">
        ...
        <view class="tui-hot-tag"
          @tap="search">自热火锅</view>
        <view class="tui-hot-tag"
          @tap="search">华为手机</view>
        <view class="tui-hot-tag"
          @tap="search">有机酸奶</view>
        <view class="tui-hot-tag"
          @tap="search">苹果手机</view>
      </view>
        ...
        <view class="tui-banner-box">
          <swiper :indicator-dots="true"
            ...
            <swiper-item v-for="(item,index) in banner"
              :key="index"
              @tap.stop="detail">
              <image :src="'../../../static/images/mall/banner/'+item"
    ...
    <view class="tui-product-category">
      <view class="tui-category-item"
        ...
        <navigator :url="item.url">
          <image :src="'../../../static/images/mall/category/'+item.img"
    ...
    <view class="tui-product-box tui-pb-20 tui-bg-white">
      ...
      <view class="tui-new-box">
        <view class="tui-new-item"
          ...
          <image :src="'../../../static/images/mall/new/'+item.pic"
        ...
        <view class="tui-product-container">
          <block v-for="(item,index) in productList"
            ...
            <view class="tui-pro-item"
              ...
              @tap="detail(item.id)">
              <image :src="'../../../static/images/mall/product/'+item.img+'.jpg'"
                class="tui-pro-img"
                mode="widthFix" />
...
export default {
  ...
  methods: {
    ...
    _load () {
      ...
      // 				let b = this.$api.http.get('/get_newProduct')
