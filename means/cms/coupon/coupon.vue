<template>
  <view class="product">
    ...
    <view class="cu-form-group">
      <view class="title">店铺红包</view>
    </view>
    <view class="cu-form-group">
      <view class="title">红包名：</view>
      <input placeholder="最多10个字"
        v-model="coupon_form.name"></input>
    </view>
    <view class="cu-form-group">
      <view class="title">面&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;值：</view>
      <input placeholder="0.01-1000000"
        v-model="coupon_form.reduce"></input>
    </view>
    <view class="cu-form-group">
      ...
      <view class="title">
        <radio-group @change="radioChange"
          ...
          v-model="coupon_form.status">
          <label class="radio"
            v-for="(item, index) in status"
            :key="item.value">
            <view class="danxuan">
              <radio class='margin-left-sm'
    ...
    <view class="cu-form-group"
      ...
      <input placeholder="0.01-1000000"
        v-model="coupon_form.full"></input>
    </view>
    <view class="cu-form-group">
      <view class="title">门槛金额：</view>
      <input placeholder="1000000"
        v-model="coupon_form.stock"></input>
    </view>
    <view class="cu-form-group margin-top"
      @click="show_cate_list=true">
      <view class="title">有效期类型：</view>
      <view class="title"
        style="padding: 0;">
        {{category_name}}&nbsp;
        <uni-icon type="arrowdown"
          size="20"
          color="#A7A7A7"></uni-icon>
      </view>
    </view>
    <view class="cu-form-group"
      v-if="category_id == 2">
    ...
    <!-- 配送方式弹窗 -->
    <uni-popup :show="show_mail_list"
      type="bottom"
      mode="fixed"
      @hidePopup="show_mail_list=false">
      <view class="uni-list leixin">
