<template>
  <view class="content">
    ...
    <view class="post"
      ...
      <view class="content"
        style="text-align: center;width: 85%;margin: 0 auto;">
        <view style="padding-top: 20upx;margin-top: 30upx;background: #ffffff;">
          <view @click="guanbi">
            <img id="test"
              style="width: 580upx;height: 954upx;" />
          </view>
        </view>
      </view>
      <!-- #ifdef APP-PLUS -->
      <image @click="guanbi"
        class="cha"
        style="width: 80upx;height: 80upx; margin-top: 25upx;margin-left: 47%;"></image>
      <!-- #endif -->
      <!-- #ifdef H5 -->
      <image @click="guanbi"
        class="cha"
        style="width: 80upx;height: 80upx; margin-top: 25upx; margin: 0;"></image>
      <!-- #endif -->
    </view>
    <!-- </view> -->
...
export default {
  ...
  methods: {
    ...
    erweima: function () {
      ...
      console.log("生成分享图的参数：", this.product_data)
      this.tishi = 1
      canvas_x.makeImage({
        type: 'url',
        parts: [{
          type: 'image',
          url: this.product_data.banner_imgs_list[0].url ? this.product_data.banner_imgs_list[0].url : '',
          width: 680,
          height: 680,
          // backgroundSize:680,
        },
