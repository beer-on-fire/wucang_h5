<template>
  <view class="tan"
    ...
    <view class="t_con">
      ...
      <view class="t_c_con"> 欢迎您访问吾仓集市！为了更好地为您提供服务与保障您的消费者权益，请使用前务必仔细阅读以下协议内容。如您选择同意，则视为您已充分阅读并理解本服务协议的内容，自愿接受本协议所约定的权利义务约束。</view>
      <view class="t_c_more">
      ...
      <view class="t_c_btn">
        <view class="t_c_btn_01 bg_red"
          @click="sapprove(true)">同意</view>
        <view class="t_c_btn_01 bg_gery"
          @click="sapprove(false)">不同意</view>
      </view>
    </view>
  </view>
</template>
